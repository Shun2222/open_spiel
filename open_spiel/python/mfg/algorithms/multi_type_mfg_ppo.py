...
def parse_args():
    ...
    parser.add_argument("--num_iterations", type=int, default=10000, help="Set the number of global update steps of the outer loop")
    parser.add_argument('--logdir', type=str, default="/mnt/shunsuke/result/1112/multi_type_maze_expert_convergence", help="logdir")
