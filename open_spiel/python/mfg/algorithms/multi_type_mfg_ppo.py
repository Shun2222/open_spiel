...
def parse_args():
    ...
    parser.add_argument("--num_iterations", type=int, default=400, help="Set the number of global update steps of the outer loop")
    parser.add_argument('--logdir', type=str, default="/mnt/shunsuke/result/1209/4rooms_maze_expert_low_collision", help="logdir")
