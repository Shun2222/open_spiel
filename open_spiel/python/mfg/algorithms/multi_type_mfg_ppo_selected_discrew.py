...
def parse_args():
    ...
    parser.add_argument('--logdir', type=str, default="/mnt/shunsuke/result/master_middle/multi_maze2_ppo_dxy_mu_mastermiddle", help="logdir")
    ...
    parser.add_argument("--path1", type=str, default= help="file path")
disc_path = [
