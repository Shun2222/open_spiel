...
def render(envs, game_name, distribs, info_states, save=False, filename="agent_dist.mp4"):
    ...
    for idx in range(num_agent):
        ...
        for k,v in distribs[idx].distribution.items():
            if "mu" in k:
        ...
        if save:
            ...
            fname = filename[0:-5] + idx + filename[-4:-1]
