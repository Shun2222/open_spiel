...
def parse_args():
    ...
    parser.add_argument("--path", type=str, default="/mnt/shunsuke/result/target_files/multi_type_maze_notmu_airlnotmu", help="file path")
    parser.add_argument("--filename", type=str, default="expert3_airlnotmu", help="file path")
    parser.add_argument("--actor_filename", type=str, default="actor80_79", help="file path")
