...
def parse_args():
    ...
    parser.add_argument("--logdir", type=str, default="/mnt/shunsuke/result/1209/multi_type_maze2_dxy_mu_svf_mf", help="log path")
...
if __name__ == "__main__":
    ...
    for seed in seeds:
        ...
        if is_common:
            ...
            from open_spiel.python.mfg.algorithms.multi_type_adversarial_inverse_rl_networks_divided_value_svf_mf import MultiTypeAIRL
