...
def parse_args():
    ...
    parser.add_argument("--expert_path", type=str, default="/mnt/shunsuke/result/0726/multi_maze2_expert/expert-45traj", help="expert path")
    ...
    parser.add_argument("--logdir", type=str, default="/mnt/shunsuke/result/1209/multi_maze2_dxy_mu-divided_value_45trajs_svf", help="log path")
...
differ_expert_path = [
                        "/mnt/shunsuke/result/0726/multi_maze2_expert/expert-selected-1traj",
