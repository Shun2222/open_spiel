...
from open_spiel.python.mfg.algorithms.discriminator_networks_divided_value_svf_model import * 
...
def parse_args():
    ...
    parser.add_argument("--logdir", type=str, default="/mnt/shunsuke/result/1209/predator_prey_group2_mu", help="log path")
