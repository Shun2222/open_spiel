...
def parse_args():
    ...
    parser.add_argument("--logdir", type=str, default="/mnt/shunsuke/result/1209/multi_maze2_dxy_mu-divided_value_particle_common-1000-1000-1000_calcMF", help="log path")
...
if __name__ == "__main__":
    ...
    for seed in seeds:
        ...
        from open_spiel.python.mfg.algorithms.multi_type_adversarial_inverse_rl_networks_divided_value_particle_common import MultiTypeAIRL
        mfg_dists = []
