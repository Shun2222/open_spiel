...
def parse_args():
    ...
    parser.add_argument("--logdir", type=str, default="/mnt/shunsuke/result/1112/multi_maze2_dxy_mu-divided_value_particle_common-15-15-15_notUpdateWeight", help="log path")
